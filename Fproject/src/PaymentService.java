 ...
 * @author DELL
 */
public class PaymentService extends javax.swing.JFrame {

    public static int Selected;

    /**
     * Creates new form PaymentService
     */
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Payment Services");
        ...
        jButton3.setText("University Fees");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentService.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentService().setVisible(true);
            }
        });
    }
