 ...
 * @author DELL
 */
public class SchoolFees extends javax.swing.JFrame {

    /**
     * Creates new form SchoolFees
     */
    public SchoolFees() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("School Fees");

        zone.setBackground(new java.awt.Color(0, 124, 169));
        zone.setFont(new java.awt.Font("Goudy Old Style", 1, 18)); // NOI18N
        zone.setForeground(new java.awt.Color(255, 255, 255));
        zone.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "East Naser City", "West Naser City", "ElShrouk", "ElWaily", "Helwan", "Shoubra" }));
        zone.setInheritsPopupMenu(true);
        ...
        jLabel3.setText("Eductional Zone");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 70, 380, 420));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (code.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Please Write your code");

        } else {
            setVisible(false);
            PayOrCancel obj = new PayOrCancel();
            obj.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SchoolFees.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SchoolFees().setVisible(true);
            }
        });
    }
