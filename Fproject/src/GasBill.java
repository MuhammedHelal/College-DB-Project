 ...
 * @author DELL
 */
public class GasBill extends javax.swing.JFrame {

    /**
     * Creates new form GasBill
     */
    public GasBill() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(360, 60, 380, 300));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GasBill.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
