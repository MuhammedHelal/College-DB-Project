...
public class Register extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        ret.setBackground(new java.awt.Color(0, 124, 169));
        ret.setFont(new java.awt.Font("Goudy Old Style", 1, 18)); // NOI18N
        ret.setForeground(new java.awt.Color(255, 255, 255));
        ret.setText("Retrun  to Login");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addComponent(Name)
                            .addComponent(Age1, javax.swing.GroupLayout.DEFAULT_SIZE, 106, Short.MAX_VALUE)
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 20, 420, 560));
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 1070, 620));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            st.execute("insert into COUSTMER values('" + N + "','" + phone + "','" + P + "','" + E + "','" + A + "')");
            String sql = "INSERT into WALLET values('" + phone + "' , '5000.0' )";
            st.execute(sql);
